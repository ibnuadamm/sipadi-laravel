...
<div class="dashboard-container">
    ...
    <div class="header-section">
        <h1><i class="bi bi-wallet2"></i> Tambah Data Beban</h1>
        ...
        <form action="{{ route('beban.store') }}" method="POST">
            ...
            <div class="form-group">
                <label for="nama_beban">
                    <i class="bi bi-card-text"></i> Nama Beban
                </label>
                <input type="text" id="nama_beban" name="nama_beban" 
                    value="{{ old('nama_beban') }}" 
                    placeholder="Contoh: Pupuk, Pestisida, Gaji Karyawan" required>
            ...
            <div class="form-group">
                <label for="nominal">
                    <i class="bi bi-currency-dollar"></i> Nominal (Rp)
                </label>
