...
<div class="dashboard-container">
    ...
    <div class="header-section">
        <h2><i class="bi bi-pencil-square"></i> Edit Data Beban</h2>
        <a href="{{ route('beban.index') }}" class="btn-back">
    ...
    <div class="form-card">
        ...
        <div class="info-box">
            ...
            <span>ID Beban: <strong>#{{ $beban->id }}</strong></span>
        </div>
        ...
        <form action="{{ route('beban.update', $beban->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" id="tanggal" name="tanggal" 
                    value="{{ $beban->tanggal->format('Y-m-d') }}" required>
            ...
            <!-- Nama Beban Field -->
            <div class="form-group">
                <label for="nama_beban">
                    <i class="bi bi-chat-left-text"></i> Nama Beban
                </label>
                <input type="text" id="nama_beban" name="nama_beban" 
                    value="{{ $beban->nama_beban }}"
                    placeholder="Contoh: Gaji Karyawan, Listrik, dll" required>
                @if ($errors->has('nama_beban'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('nama_beban') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                <label for="nominal">
                    <i class="bi bi-cash-coin"></i> Nominal
                </label>
                ...
                @if ($errors->has('nominal'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('nominal') }}
                    </span>
                @endif
            </div>
            ...
            <div class="button-group">
                ...
                <a href="{{ route('beban.index') }}" class="btn-cancel">
