...
<style>
    * {
    ...
    /* Input type date calendar styling */
...
<div class="dashboard-container">
    ...
    <div class="header-section">
        <h1><i class="bi bi-eye"></i> Tambah Pemantauan Tanam</h1>
    ...
    <div class="form-card">
        ...
        <form action="{{ route('pemantauan.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="persediaan_id" name="persediaan_id" required>
                    <option value="">-- Pilih Bibit --</option>
                    @foreach($persediaan as $item)
                        <option value="{{ $item->id }}" {{ old('persediaan_id') == $item->id ? 'selected' : '' }}>
                            {{ $item->nama_barang }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" id="lahan" name="lahan" 
                    value="{{ old('lahan') }}"
                    placeholder="Contoh: Lahan A / Lahan 1">
                @if ($errors->has('lahan'))
                    <span class="error-message">
            ...
            <div class="form-group">
                <label for="jumlah_tanam">
                    <i class="bi bi-basket"></i> Jumlah Ditanam
                </label>
                <input type="number" id="jumlah_tanam" name="jumlah_tanam" 
                    value="{{ old('jumlah_tanam') }}"
                    min="1" placeholder="Contoh: 100" required>
