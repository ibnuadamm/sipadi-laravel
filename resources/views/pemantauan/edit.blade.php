...
<div class="dashboard-container">
    ...
    <div class="header-section">
        <h2><i class="bi bi-pencil-square"></i> Edit Pemantauan</h2>
        <a href="{{ route('pemantauan.index') }}" class="btn-back">
    ...
    <div class="form-card">
        ...
        <div class="info-box">
            ...
            <span>ID Pemantauan: <strong>#{{ $pemantauan->id }}</strong></span>
        </div>
        ...
        <form action="{{ route('pemantauan.update', $pemantauan->id) }}" method="POST">
            ...
            <div class="form-group">
                <label for="persediaan_id">
                    <i class="bi bi-leaf"></i> Nama Bibit
                </label>
                <select name="persediaan_id" id="persediaan_id" required>
                ...
                @if ($errors->has('persediaan_id'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('persediaan_id') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                <label for="lahan">
                    <i class="bi bi-map"></i> Lahan
                </label>
                <input type="text" id="lahan" name="lahan" 
                    value="{{ $pemantauan->lahan }}"
                    placeholder="Contoh: Lahan A, Lahan B">
                @if ($errors->has('lahan'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('lahan') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                <label for="tanggal_tanam">
                    <i class="bi bi-calendar-event"></i> Tanggal Tanam
                </label>
                <input type="date" id="tanggal_tanam" name="tanggal_tanam" 
                    value="{{ $pemantauan->tanggal_tanam->format('Y-m-d') }}" required>
                @if ($errors->has('tanggal_tanam'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('tanggal_tanam') }}
                    </span>
                @endif
            </div>

            <!-- Jumlah Ditanam Field -->
            <div class="form-group">
                <label for="jumlah_tanam">
                    <i class="bi bi-bag-plus"></i> Jumlah Ditanam
                </label>
                <input type="number" id="jumlah_tanam" name="jumlah_tanam" 
                    value="{{ $pemantauan->jumlah_tanam }}"
                    placeholder="Contoh: 100" min="1" required>
                @if ($errors->has('jumlah_tanam'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('jumlah_tanam') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                <label for="tanggal_panen">
                    <i class="bi bi-calendar-check"></i> Tanggal Panen
                </label>
                <input type="date" id="tanggal_panen" name="tanggal_panen" 
                    value="{{ $pemantauan->tanggal_panen?->format('Y-m-d') }}">
                @if ($errors->has('tanggal_panen'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('tanggal_panen') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                <label for="jumlah_panen">
                    <i class="bi bi-bag-check"></i> Jumlah Panen
                </label>
                <input type="number" id="jumlah_panen" name="jumlah_panen" 
                    value="{{ $pemantauan->jumlah_panen }}"
                    placeholder="Contoh: 80">
                @if ($errors->has('jumlah_panen'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('jumlah_panen') }}
                    </span>
                @endif
            </div>
            ...
            <div class="button-group">
                ...
                <a href="{{ route('pemantauan.index') }}" class="btn-cancel">
