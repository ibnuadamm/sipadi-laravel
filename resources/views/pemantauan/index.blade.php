...
<div class="dashboard-container">
    ...
    <div class="header-section">
        <h1><i class="bi bi-eye"></i> Data Pemantauan</h1>
        <a href="{{ route('pemantauan.create') }}" class="btn-tambah">
            <i class="bi bi-plus-circle"></i> Tambah Pemantauan
        </a>
    </div>
                    ...
                    <td>
                        @if($item->status == 'Sudah Dipanen')
                            <span class="status-badge status-selesai">
                                <i class="bi bi-check-circle"></i> Sudah Dipanen
                            </span>
                        @else
                            <span class="status-badge status-proses">
                                <i class="bi bi-hourglass-split"></i> Dalam Pemeliharaan
                            </span>
                        @endif
                    </td>
                    <td>
                        <a href="{{ route('pemantauan.edit', $item->id) }}" class="btn-action btn-edit">
    ...
    @else
        <div class="empty-state">
            ...
            <p>Belum ada data pemantauan. <a href="{{ route('pemantauan.create') }}" class="btn-tambah" style="margin-top: 15px;">Tambah Pemantauan Sekarang</a></p>
        </div>
    @endif
</div>
