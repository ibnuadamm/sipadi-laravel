...
<div class="dashboard-container">
    ...
    <div class="header-section">
        <h2><i class="bi bi-pencil-square"></i> Edit Pembelian</h2>
    ...
    <div class="form-card">
        ...
        <div class="info-box">
            ...
            <span>ID Pembelian: <strong>#{{ $pembelian->id }}</strong></span>
        </div>
        ...
        <form action="{{ route('pembelian.update', $pembelian->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" id="tanggal" name="tanggal" 
                    value="{{ $pembelian->tanggal->format('Y-m-d') }}" required>
            ...
            <div class="button-group">
                ...
                <a href="{{ route('pembelian.index') }}" class="btn-cancel">
