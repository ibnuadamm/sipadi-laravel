...
<div class="dashboard-container">
    ...
    <div class="header-section">
        <h2><i class="bi bi-pencil-square"></i> Edit Penjualan</h2>
    ...
    <div class="form-card">
        ...
        <div class="info-box">
            ...
            <span>ID Penjualan: <strong>#{{ $penjualan->id }}</strong></span>
        </div>
        ...
        <form action="{{ route('penjualan.update', $penjualan->id) }}" method="POST">
            ...
            <div class="form-group">
                <label for="qty">
                    <i class="bi bi-bag-plus"></i> Jumlah (Qty)
                </label>
                ...
                @if ($errors->has('qty'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('qty') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                <label for="harga_satuan">
                    <i class="bi bi-cash-coin"></i> Harga Satuan
                </label>
                <input type="number" id="harga_satuan" name="harga_satuan" 
                    value="{{ $penjualan->harga_satuan }}"
                    placeholder="Contoh: 50000" required>
                @if ($errors->has('harga_satuan'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('harga_satuan') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if ($errors->has('tanggal'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('tanggal') }}
                    </span>
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="keterangan" name="keterangan" 
                    placeholder="Contoh: Pembelian untuk persediaan, pesanan khusus, dll">{{ $penjualan->keterangan }}</textarea>
                @if ($errors->has('keterangan'))
                    <span class="error-message">
                        <i class="bi bi-exclamation-circle"></i> {{ $errors->first('keterangan') }}
                    </span>
                @endif
            </div>
            ...
            <div class="button-group">
                ...
                <a href="{{ route('penjualan.index') }}" class="btn-cancel">
